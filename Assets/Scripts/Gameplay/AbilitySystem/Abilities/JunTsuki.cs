...
public class JunTsuki : Ability {
    ...
    protected override void Awake() {
        base.Awake();
        punchPrefab = Resources.Load<GameObject>("Abilities/Prefabs/JunTsuki");
    ...
    public override void Activate() {
        ...
        tsuki.GetComponentInChildren<SpriteRenderer>().flipY = (angle > 90 || angle < -90) ? true : false;
